...
import { HiOutlineDocumentText, HiOutlineDownload, HiOutlineUserGroup } from "react-icons/hi";
...
const UserReport = () => {
  ...
  useEffect(() => {
    // Simulating API call with dummy data for multiple employees
...
5. All HIV tests came back negative. Continue promoting safe sex education and regular testing.`
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      pdf.save(`Company_Health_Report_${report.eventInfo?.name || "Event"}.pdf`);
  ...
  if (!report) {
    return (
      <div className="text-center py-12">
        ...
        <p className="text-lg text-gray-600">No company health report found</p>
      </div>
    );
  }
    ...
    <div className="p-6 bg-white rounded-xl shadow-md space-y-6">
      ...
      <div className="flex justify-end">
        ...
        >
          ...
          {isExporting ? "Exporting..." : "Download Company Report"}
        </button>
      </div>
      ...
      <div ref={reportRef} className="space-y-8">
        ...
        <div className="text-center mb-8">
          <h2 className="text-3xl font-bold text-[#992787] flex items-center justify-center gap-3">
            ...
            Company Health Assessment Report
          </h2>
          <div className="mt-4 bg-[#f8f5fa] p-4 rounded-lg">
            <h3 className="text-xl font-semibold text-gray-800">{report.eventInfo.name}</h3>
            <p className="text-gray-600">
              {new Date(report.eventInfo.date).toLocaleDateString()} | {report.eventInfo.location}
            </p>
            <p className="mt-2 font-medium">
              Total Participants: <span className="text-[#992787]">{report.participants} employees</span>
            </p>
          </div>
        </div>
